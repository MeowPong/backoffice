    ...
    try{
      ...
      if ( res.data.message === 'success' ) {
        Swal.fire({
          ...
          text: 'success',
          icon: 'success',
          timer: 500 // 1000 = 1 sec
        })
      }

      // ปิด modal อัตโนมัติ เมื่อเซฟเสร็จ
  ...
  return (
    ...
    <BackOffice>
      ...
      <button 
        ...
        onClick={clearForm}
        >
        <i className='fa fa-plus'></i><span className='ml-2'>เพิ่มรายการ</span>
      </button>
      <button 
        ...
        >
        <i className='fa fa-arrow-down mr-2'></i><span>Import from Excel</span>
      </button>
      ...
      <MyModal id='modalExcel' title='เลือกไฟล์'>
        ...
        >
          <i className='fa fa-check mr-2'></i><span>Save</span>
        </button>
      </MyModal>
