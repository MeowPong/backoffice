...
function BillSale() {
    ...
    // handleSend  (สถานะจัดส่งสินค้าแล้ว)
    const handleSend = async(item) => {
        try{
            const button = await Swal.fire({
                title: 'ยืนยันการจัดส่งสินค้า',
                text: 'คุณต้องการยืนยันว่ามีการจัดส่งสินค้าแล้ว',
                icon: 'question',
                showCancelButton: true,
                showConfirmButton: true
            });
    ...
    // handleCancel  (สถานะยกเลิกคำสั่งซื้อ)
    const handleCancel = async(item) => {
        try{
            const button = await Swal.fire({
                title: 'ยืนยันการยกเลิก',
                text: 'คุณต้องการยดเลิกรายการบิลนี้ทั้งหมด',
                icon: 'question',
                showCancelButton: true,
                showConfirmButton: true
            });
